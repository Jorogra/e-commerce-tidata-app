...
```bash
git remote add encore encore://e-commerce-platform-ggci
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/e-commerce-platform-ggci/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/e-commerce-platform-ggci/settings/integrations/github)
