...
function CartProvider({ children }) {
  ...
  const addItem = (product2) => {
    setItems((prev) => {
      const existing = prev.find((item) => item.product.id === product2.id);
      if (existing) {
        return prev.map(
          (item) => item.product.id === product2.id ? { ...item, quantity: Math.min(item.quantity + 1, product2.stockQuantity) } : item
        );
      }
      return [...prev, { product: product2, quantity: 1 }];
    });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CartContext.Provider, { value: { items, addItem, removeItem, updateQuantity, clearCart }, children });
}
function useCart() {
...
((order2) => {
  class ServiceClient {
     ...
     */
    async list() {
      const resp = await this.baseClient.callTypedAPI(`/orders`, { method: "GET", body: void 0 });
      return JSON.parse(await resp.text(), dateReviver);
    }
    async search(params) {
      const resp = await this.baseClient.callTypedAPI(`/orders/search/${encodeURIComponent(params.orderNumber)}`, { method: "GET", body: void 0 });
      return JSON.parse(await resp.text(), dateReviver);
    }
  }
  order2.ServiceClient = ServiceClient;
})(order || (order = {}));
var product;
((product2) => {
  class ServiceClient {
     ...
     */
    async list() {
      const resp = await this.baseClient.callTypedAPI(`/products`, { method: "GET", body: void 0 });
      return JSON.parse(await resp.text(), dateReviver);
    }
    /**
     * Deletes a product.
     */
    async remove(params) {
      await this.baseClient.callTypedAPI(`/products/${encodeURIComponent(params.id)}`, { method: "DELETE", body: void 0 });
    }
    /**
     * Updates a product.
     */
...
class BaseClient {
  constructor(baseURL, options) {
    ...
    this.headers = {};
    if (!BROWSER) {
      this.headers["User-Agent"] = "e-commerce-platform-ggci-Generated-TS-Client (Encore/v1.53.8)";
    }
...
function ProductCard({ product: product2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden transition-all active:scale-[0.98]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-[4/3] bg-muted relative", children: [
      product2.imageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
...
function AdminPanel() {
  ...
  const createMutation = useMutation({
    mutationFn: (data) => backend.product.create(data),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, ...data }) => backend.product.update({ id, ...data }),
    onSuccess: () => {
      queryClient2.invalidateQueries({ queryKey: ["products"] });
      setIsDialogOpen(false);
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "name",
                    name: "name",
                    defaultValue: editingProduct == null ? void 0 : editingProduct.name,
                    required: true
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Textarea,
                  {
                    id: "description",
                    name: "description",
                    defaultValue: editingProduct == null ? void 0 : editingProduct.description,
                    rows: 3
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ...
                    step: "0.01",
                    min: "0",
                    defaultValue: editingProduct == null ? void 0 : editingProduct.price,
                    required: true
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ...
                    type: "number",
                    min: "0",
                    defaultValue: editingProduct == null ? void 0 : editingProduct.stockQuantity,
                    required: true
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ...
                    name: "imageUrl",
                    type: "url",
                    defaultValue: editingProduct == null ? void 0 : editingProduct.imageUrl,
                    placeholder: "https://..."
                  }
                )
              ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", disabled: isPending, children: isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-4 w-4" }) })
      ] }) })
    ] }),
    order2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
              "Email: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: order2.customerEmail })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      isLoadingOrders ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-muted-foreground" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4", children: ordersData == null ? void 0 : ordersData.orders.map((orderItem) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: orderItem.orderNumber }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-1", children: [
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-4", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-center py-12", children: "Your cart is empty" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-16 text-center font-medium text-lg", children: item.quantity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  variant: "outline",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed bottom-0 left-0 right-0 bg-background border-t z-50 safe-area-inset-bottom", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-around h-16", children: tabs.map((tab) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: `flex flex-col items-center justify-center flex-1 h-full gap-1 transition-colors ${isActive ? "text-foreground" : "text-muted-foreground hover:text-foreground"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: `h-6 w-6 ${isActive ? "fill-current" : ""}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: tab.label })
        ]
      },
      tab.id
    );
